...
// Framework type is now imported from ermits types to maintain consistency
// Re-export for backward compatibility
export type { Framework } from '../../types/ermits';
export type { FrameworkChange, Section, Category, Question, MaturityLevel, LearningResource, Option } from '../../types/ermits';
