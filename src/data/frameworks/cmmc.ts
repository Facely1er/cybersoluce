...
export const cmmcFramework: Framework = {
  ...
  prerequisites: ['Understanding of CUI requirements', 'Familiarity with DoD security standards'],
  certificationBody: 'CMMC-AB',
  lastUpdated: new Date('2021-11-04'),
  relatedFrameworks: ['NIST SP 800-171', 'NIST SP 800-53', 'DFARS'],
  applicableRegulations: ['DFARS', 'CMMC', 'FISMA'],
  maturityLevels: [
    { level: 1, name: 'Foundational', description: 'Basic cyber hygiene', color: '#ef4444', minScore: 0, maxScore: 20 },
    { level: 2, name: 'Developing', description: 'Intermediate cyber hygiene', color: '#f97316', minScore: 21, maxScore: 40 },
    { level: 3, name: 'Defined', description: 'Documented cybersecurity program', color: '#eab308', minScore: 41, maxScore: 60 },
    { level: 4, name: 'Managed', description: 'Measured cybersecurity program', color: '#22c55e', minScore: 61, maxScore: 80 },
    { level: 5, name: 'Expert', description: 'Advanced/progressive cybersecurity', color: '#3b82f6', minScore: 81, maxScore: 100 }
  ],
  sections: [
    {
      id: 'access-control',
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete access control framework' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete transaction and function controls' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete information flow control' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete separation of duties framework' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete least privilege implementation' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete separation of privileged/non-privileged use' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete privileged function control and logging' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete failed logon attempt management' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.9',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Comprehensive system use notifications' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.10',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete session lock implementation' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.11',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete session termination management' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.12',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete remote access monitoring and control' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.13',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete remote access encryption' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.14',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'All remote access through managed control points' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.15',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete authorization for remote privileged access' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.16',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete wireless access authorization' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.17',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete wireless authentication and encryption' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.18',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete mobile device connection management' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.19',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete mobile device encryption' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.20',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete external system verification and control' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.21',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete portable storage device control' }
              ]
            },
            {
              id: 'cmmc.ac.3.1.22',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete control of CUI on public systems' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Comprehensive training program for all personnel' }
              ]
            },
            {
              id: 'cmmc.at.3.2.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete role-based security training program' }
              ]
            },
            {
              id: 'cmmc.at.3.2.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete insider threat recognition and reporting training' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete audit logging and retention' }
              ]
            },
            {
              id: 'cmmc.au.3.3.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete user action traceability' }
              ]
            },
            {
              id: 'cmmc.au.3.3.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete periodic review and update process' }
              ]
            },
            {
              id: 'cmmc.au.3.3.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete audit logging failure alerting' }
              ]
            },
            {
              id: 'cmmc.au.3.3.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete audit record correlation' }
              ]
            },
            {
              id: 'cmmc.au.3.3.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete audit record reduction and reporting' }
              ]
            },
            {
              id: 'cmmc.au.3.3.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete system time synchronization' }
              ]
            },
            {
              id: 'cmmc.au.3.3.8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete audit information protection' }
              ]
            },
            {
              id: 'cmmc.au.3.3.9',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete audit management privilege limitation' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete baseline configuration and inventory management' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete security configuration management' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete change management process' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete security impact analysis process' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete change access restriction framework' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete least functionality implementation' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete restriction of nonessential functions' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete software execution control policy' }
              ]
            },
            {
              id: 'cmmc.cm.3.4.9',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete user-installed software control and monitoring' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete identification framework' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete authentication framework' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete MFA implementation' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete replay-resistant authentication' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete identifier reuse prevention' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete inactivity-based identifier management' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete password complexity enforcement' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete password reuse prevention' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.9',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete temporary password management' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.10',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'All passwords cryptographically protected' }
              ]
            },
            {
              id: 'cmmc.ia.3.5.11',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete authentication feedback obscuring' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete incident response capability' }
              ]
            },
            {
              id: 'cmmc.ir.3.6.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete incident tracking and reporting' }
              ]
            },
            {
              id: 'cmmc.ir.3.6.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete incident response testing program' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete system maintenance program' }
              ]
            },
            {
              id: 'cmmc.ma.3.7.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete maintenance control program' }
              ]
            },
            {
              id: 'cmmc.ma.3.7.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete sanitization for off-site maintenance' }
              ]
            },
            {
              id: 'cmmc.ma.3.7.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete maintenance media security checking' }
              ]
            },
            {
              id: 'cmmc.ma.3.7.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete MFA and session management for remote maintenance' }
              ]
            },
            {
              id: 'cmmc.ma.3.7.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete supervision of all unauthorized maintenance personnel' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete media protection program' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete media access control' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete media sanitization program' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete media marking program' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete media transport control and accountability' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete cryptographic protection for media transport' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete removable media control program' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete portable device ownership program' }
              ]
            },
            {
              id: 'cmmc.mp.3.8.9',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete backup CUI protection program' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete personnel screening program' }
              ]
            },
            {
              id: 'cmmc.ps.3.9.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete personnel action protection program' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete physical access control program' }
              ]
            },
            {
              id: 'cmmc.pe.3.10.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete facility protection and monitoring' }
              ]
            },
            {
              id: 'cmmc.pe.3.10.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete visitor escort and monitoring program' }
              ]
            },
            {
              id: 'cmmc.pe.3.10.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete physical access logging program' }
              ]
            },
            {
              id: 'cmmc.pe.3.10.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete physical access device management' }
              ]
            },
            {
              id: 'cmmc.pe.3.10.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete alternate work site safeguarding' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete periodic risk assessment program' }
              ]
            },
            {
              id: 'cmmc.ra.3.11.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete vulnerability scanning program' }
              ]
            },
            {
              id: 'cmmc.ra.3.11.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete risk-based vulnerability remediation' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete security control assessment program' }
              ]
            },
            {
              id: 'cmmc.ca.3.12.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete deficiency management and remediation' }
              ]
            },
            {
              id: 'cmmc.ca.3.12.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete continuous security control monitoring' }
              ]
            },
            {
              id: 'cmmc.ca.3.12.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete system security planning program' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete boundary communications protection' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete security engineering program' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete functional separation' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete shared resource information protection' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete subnetwork implementation for public components' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete deny-all, permit-by-exception policy' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete split tunneling prevention' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete CUI transmission encryption' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.9',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete network connection termination management' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.10',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete cryptographic key management program' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.11',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete FIPS-validated cryptography for CUI' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.12',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete collaborative device activation control' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.13',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete mobile code control and monitoring' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.14',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete VoIP control and monitoring' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.15',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete communications session authenticity protection' }
              ]
            },
            {
              id: 'cmmc.sc.3.13.16',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete CUI at rest protection' }
              ]
            }
          ]
        }
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete flaw management program' }
              ]
            },
            {
              id: 'cmmc.si.3.14.2',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete malicious code protection program' }
              ]
            },
            {
              id: 'cmmc.si.3.14.3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete security alert management program' }
              ]
            },
            {
              id: 'cmmc.si.3.14.4',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete malicious code protection update program' }
              ]
            },
            {
              id: 'cmmc.si.3.14.5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete system and file scanning program' }
              ]
            },
            {
              id: 'cmmc.si.3.14.6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete system monitoring for attack detection' }
              ]
            },
            {
              id: 'cmmc.si.3.14.7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive implementation', description: 'Complete unauthorized use identification program' }
              ]
            }
          ]
        }
