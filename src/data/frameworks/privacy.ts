          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Fully inventoried', description: 'Comprehensive, automated, real-time inventory with comprehensive data mapping' }
              ]
            },
            {
              id: 'privacy.id.im.p2',
              ...
              options: [
                ...
                { value: 3, label: 'Fully identified', description: 'Comprehensive ownership mapping with accountability frameworks' }
              ]
            },
            {
              id: 'privacy.id.im.p3',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive identification', description: 'All individual categories comprehensively documented and maintained' }
              ]
            },
            {
              id: 'privacy.id.im.p4',
              ...
              options: [
                ...
                { value: 3, label: 'Fully inventoried', description: 'Comprehensive data action inventory with automated tracking' }
              ]
            },
            {
              id: 'privacy.id.im.p5',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive inventory', description: 'All processing purposes comprehensively documented and linked to legal bases' }
              ]
            },
            {
              id: 'privacy.id.im.p6',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive inventory', description: 'Detailed PII data element inventory with sensitivity classifications' }
              ]
            },
            {
              id: 'privacy.id.im.p7',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive inventory', description: 'Detailed permissions and obligations with automated compliance tracking' }
              ]
            },
            {
              id: 'privacy.id.im.p8',
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive mapping', description: 'Detailed data flow mapping with real-time monitoring' }
              ]
            }
          ]
        },
          ...
          questions: [
            {
              ...
              options: [
                ...
                { value: 3, label: 'Fully identified', description: 'Comprehensive role clarity with comprehensive communication' }
              ]
            },
            {
              id: 'privacy.id.be.p2',
            ...
            },
            {
              ...
              options: [
                ...
                { value: 3, label: 'Comprehensive identification', description: 'Detailed stakeholder analysis with clear accountability' }
              ]
            }
          ]
        },
