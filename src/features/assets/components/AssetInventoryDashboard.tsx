...
export const AssetInventoryDashboard: React.FC = () => {
  ...
  const getSelectedAssetsList = (): CoreAsset[] => {
    return assets.filter((asset: CoreAsset) => selectedAssets.includes(asset.id));
  };
          ...
          {loading ? (
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                {paginatedAssets.map((asset: CoreAsset) => (
                  <tr
                    key={asset.id}
