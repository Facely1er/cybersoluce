...
export const SmartRecommendationEngine: React.FC<SmartRecommendationEngineProps> = ({
  ...
  }, [assessment, framework, generateSmartRecommendation]);

  const generateSmartRecommendation = (question: { id: string; text: string }, response: number, section: { id: string; name: string }, category: { id: string; name: string }): SmartRecommendation | null => {
  ...
  const generateNISTRecommendation = (id: string, question: { id: string; text: string }, response: number, section: { id: string; name: string }, category: { id: string; name: string }): SmartRecommendation => {
  ...
  const generateISO27001Recommendation = (id: string, question: { id: string; text: string }, response: number, section: { id: string; name: string }, category: { id: string; name: string }): SmartRecommendation => {
    return {
      id,
  ...
  const generateCMMCRecommendation = (id: string, question: { id: string; text: string }, response: number, section: { id: string; name: string }, category: { id: string; name: string }): SmartRecommendation => {
    return {
      id,
  ...
  const generateGenericRecommendation = (id: string, question: { id: string; text: string }, response: number, section: { id: string; name: string }, category: { id: string; name: string }): SmartRecommendation => {
    return {
      id,
