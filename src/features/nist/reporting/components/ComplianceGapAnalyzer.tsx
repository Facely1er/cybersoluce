  ...
  const gapAnalysis = useMemo(() => {
    ...
    return nistCSFv2Framework.sections.map(section => {
      ...
      return {
        ...
        gap,
        priority,
        recommendations: generateRecommendations(section.id, _gap),
        estimatedEffort,
        timeframe,
        businessImpact: getBusinessImpact(section.id, _gap),
        requiredActions: getRequiredActions(section.id, _gap)
      } as GapAnalysis;
