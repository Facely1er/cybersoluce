...
import { 
  ...
  Download, Eye, Search, Calendar, Users,
  Target, Shield
} from 'lucide-react';
import { Breadcrumbs } from '../../../../shared/components/layout';
import { Evidence, EvidenceCollection, EvidenceStatus, EvidenceType } from '../types';
...
export const EvidenceCollectionDashboard: React.FC<EvidenceCollectionDashboardProps> = ({
  ...
  const handleUploadEvidence = (e: React.FormEvent) => {
    ...
    setEvidenceCollections(evidenceCollections.map(collection => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <Breadcrumbs 
          items={[
            { label: 'Evidence Collection', isActive: true }
          ]} 
        />
      </div>
            ...
            <form onSubmit={handleUploadEvidence} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setUploadFormData(prev => ({ ...prev, type: e.target.value as EvidenceType }))}
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setUploadFormData(prev => ({ ...prev, confidentialityLevel: e.target.value as 'public' | 'internal' | 'confidential' | 'restricted' }))}
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
