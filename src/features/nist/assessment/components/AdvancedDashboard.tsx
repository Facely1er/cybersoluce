...
const { BarChart3, Clock, CheckCircle, FileText, Shield, Target } = LucideIcons;

import { Breadcrumbs } from '../../../../shared/components/layout';
import { RelatedLinks } from '../../../../shared/components/ui/RelatedLinks';
import { QuickNavigationPanel } from '../../../../shared/components/ui/QuickNavigationPanel';
...
export const AdvancedDashboard: React.FC<AdvancedDashboardProps> = ({
  ...
  onImportAssessment,
  userProfile,
  addNotification: _addNotification // eslint-disable-line @typescript-eslint/no-unused-vars
}) => {
  ...
  const linking = useInternalLinking();
  const contextualLinks = ((linking as { contextualLinks?: Array<{ label: string; href: string }> }).contextualLinks || []) as Array<{ label: string; href: string }>;
  const breadcrumbs = (linking as { breadcrumbs?: Array<{ label: string; href?: string }> }).breadcrumbs || [];
  ...
  useEffect(() => {
    savedAssessments.forEach(assessment => {
      ...
      if (ref) {
        ...
        const totalQuestions = nistCSFv2Framework.sections.reduce((sum: number, section: { categories: Array<{ questions: unknown[] }> }) => 
          sum + section.categories.reduce((catSum: number, category: { questions: unknown[] }) => 
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-3">
              {userProfile ? `Welcome back, ${userProfile.name}` : 'NIST CSF v2.0 Implementation'}
            </h1>
            <p className="text-lg text-gray-600 dark:text-gray-300">
              {userProfile 
                ? `Manage NIST CSF v2.0 implementation for ${userProfile.organization}`
                : 'Comprehensive cybersecurity framework implementation platform'
              }
            </p>
            {userProfile && (
      ...
      <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-800/50 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 mb-10">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Complete implementation workflow from assessment to continuous monitoring
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="p-3 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl group-hover:from-blue-200 group-hover:to-blue-300 dark:group-hover:from-blue-800/50 dark:group-hover:to-blue-700/50 transition-all duration-300 group-hover:scale-110">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  ~{nistCSFv2Framework.estimatedTime} minutes • {nistCSFv2Framework.complexity}
                </p>
              </div>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
              Start a comprehensive NIST CSF v2.0 assessment to evaluate your current cybersecurity posture and identify implementation priorities.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
              Monitor your NIST CSF v2.0 implementation progress with real-time compliance status and gap analysis.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
              Collect and manage compliance evidence for all NIST CSF v2.0 controls with automated workflows.
            </p>
          </Link>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div className="flex-1 max-w-lg">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search NIST CSF v2.0 assessments..."
                value={searchTerm}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                NIST CSF v2.0 Assessments ({filteredAndSortedAssessments.length})
              </h2>
            </div>
          ...
          <div className="p-16 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md mx-auto">
              {savedAssessments.length === 0 
                ? 'Start your first NIST CSF v2.0 assessment to begin implementation'
            ...
            {savedAssessments.length === 0 && (
              ...
              >
                ...
                <span className="font-semibold">Start NIST CSF v2.0 Assessment</span>
              </button>
            )}
          </div>
        ) : (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              Are you sure you want to delete this NIST CSF v2.0 assessment? This action cannot be undone.
            </p>
