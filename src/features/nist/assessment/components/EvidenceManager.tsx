...
import { 
  ...
  CheckCircle, Calendar, User, Trash2, Link,
  Star
} from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="evidence-name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Document Name
                </label>
                <input
                  id="evidence-name"
              ...
              <div>
                <label htmlFor="evidence-type" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Evidence Type
                </label>
                <select
                  id="evidence-type"
              ...
              <div>
                <label htmlFor="evidence-description" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Description
                </label>
                <textarea
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="evidence-relevance" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Relevance
                  </label>
                  <select
                ...
                <div>
                  <label htmlFor="evidence-confidence" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Confidence
                  </label>
                  <select
              ...
              <div>
                <label htmlFor="evidence-tags" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              ...
              <div>
                <label htmlFor="evidence-file" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Select File
                </label>
                <input
                  id="evidence-file"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-4xl w-full mx-4 shadow-2xl border border-gray-200 dark:border-gray-700 max-h-[80vh] overflow-hidden">
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <select
                id="evidence-filter-type"
                name="evidence-filter-type"
                value={filterType}
