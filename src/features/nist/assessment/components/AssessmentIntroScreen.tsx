...
export const AssessmentIntroScreen: React.FC<AssessmentIntroScreenProps> = ({
  ...
  const highPriorityQuestions = framework?.sections?.reduce((sum, section) => 
    sum + (section.categories?.reduce((catSum, category) => 
      catSum + (category.questions?.filter(q => q.priority === 'high').length || 0), 0) || 0), 0) || 0;
  ...
  const handleOrganizationSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onStartAssessment(organizationInfo as OrganizationInfo);
  };
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Assessment Overview & Preparation
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className={`px-6 py-3 rounded-full border-2 font-bold text-lg ${getComplexityColor(framework?.complexity || 'medium')}`}>
                {framework?.complexity ? (framework.complexity.charAt(0).toUpperCase() + framework.complexity.slice(1)) : 'Unknown'} Complexity
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {getFrameworkBenefits(framework?.id || '').map((benefit, index) => (
            ...
            {framework?.industry && framework.industry.length > 0 && (
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                ...
                <div className="flex flex-wrap gap-3">
                  {framework?.industry?.map((industry, index) => (
                    <span
                      key={index}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="space-y-6">
              {framework?.sections?.map((section, index) => {
                const sectionQuestions = section?.categories?.reduce((sum, cat) => sum + (cat?.questions?.length || 0), 0) || 0;
                const highPriorityInSection = section?.categories?.reduce((sum, cat) => 
                  sum + (cat?.questions?.filter(q => q.priority === 'high').length || 0), 0) || 0;
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {getPreparationChecklist(framework?.id || '').map((item, index) => (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sticky top-24">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">
                  {framework?.estimatedTime || 0} minutes
                </span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">
                  {framework?.maturityLevels?.length || 0}
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-2">
                {framework?.maturityLevels?.map((level, index) => (
