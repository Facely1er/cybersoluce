...
import { 
  ...
  Server, Database, Building, Cloud,
  Plus, Trash2, Link2, Target
} from 'lucide-react';
import { Breadcrumbs } from '../../../../shared/components/layout';
import { Asset, AssetCategory, CriticalityLevel, InformationClassification, AssetStatus } from '../../../shared/types/assets';
      ...
      <div className="mb-6">
        <Breadcrumbs 
          items={[
            ...
            { label: asset.name, isActive: true }
          ]} 
        />
      </div>
        ...
        <div className="border-b border-gray-200 dark:border-gray-700">
          <nav className="flex space-x-8 px-6">
            {[
              ...
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id as 'overview' | 'controls' | 'dependencies' | 'vulnerabilities' | 'risk')}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="asset-name-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Name
                      </label>
                      {isEditing ? (
                        <input
                          id="asset-name-edit"
                          name="asset-name-edit"
                          type="text"
                    ...
                    <div>
                      <label htmlFor="asset-description-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Description
                      </label>
                      {isEditing ? (
                        <textarea
                          id="asset-description-edit"
                          name="asset-description-edit"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="asset-category-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Category
                        </label>
                        {isEditing ? (
                          <select
                            ...
                            onChange={(e) => setEditedAsset(prev => ({ ...prev, category: e.target.value as AssetCategory }))}
                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          >
                      ...
                      <div>
                        <label htmlFor="asset-criticality-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Criticality
                        </label>
                        {isEditing ? (
                          <select
                            id="asset-criticality-edit"
                            name="asset-criticality-edit"
                            value={editedAsset.criticality}
                            onChange={(e) => setEditedAsset(prev => ({ ...prev, criticality: e.target.value as CriticalityLevel }))}
                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          >
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="asset-classification-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Information Classification
                      </label>
                      {isEditing ? (
                        <select
                          id="asset-classification-edit"
                          name="asset-classification-edit"
                          value={editedAsset.informationClassification}
                          onChange={(e) => setEditedAsset(prev => ({ ...prev, informationClassification: e.target.value as InformationClassification }))}
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="asset-owner-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Owner
                        </label>
                        {isEditing ? (
                          <input
                            id="asset-owner-edit"
                            name="asset-owner-edit"
                            type="text"
                      ...
                      <div>
                        <label htmlFor="asset-custodian-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Custodian
                        </label>
                        {isEditing ? (
                          <input
                            id="asset-custodian-edit"
                            name="asset-custodian-edit"
                            type="text"
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="asset-status-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Status
                      </label>
                      {isEditing ? (
                        <select
                          id="asset-status-edit"
                          name="asset-status-edit"
                          value={editedAsset.status}
                          onChange={(e) => setEditedAsset(prev => ({ ...prev, status: e.target.value as AssetStatus }))}
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
